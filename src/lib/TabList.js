...
<div style={{marginTop:30}}>
    ...
    />
        ...
        >{qrscan.text}</p>
<br/>
<Box sx={{ minWidth: "100%", bgcolor: 'background.paper', pl: "85px" }}>
    <Tabs
        value={value}
        ...
        aria-label="pestañas"
    >
        <Tab label="Informacion de la orden de produccion" {...a11yProps(0)} />
        <Tab label="Dispositivos utilizados" {...a11yProps(1)} />
        <Tab label="Temperaturas del proceso" {...a11yProps(2)} />
        <Tab label="Parametros del proceso" {...a11yProps(3)} />
        <Tab label="Cavidades habilitadas en produccion" {...a11yProps(4)} />
        <Tab label="Observaciones" {...a11yProps(5)} />
    </Tabs>
